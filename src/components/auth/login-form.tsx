...
export function LoginForm({ className, ...props }: React.ComponentPropsWithoutRef<"div">) {
  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
        ...
        <CardContent>
          <form onSubmit={handleSubmit}>
            <div className="grid gap-6">
              ...
              <div className="after:border-black relative text-center text-sm after:absolute after:inset-0 after:top-1/2 after:z-0 after:flex after:items-center after:border-t">
                <span className="bg-white text-black relative z-10 px-2">
                  Or continue with
                </span>
              </div>
              <div className="grid gap-6">
                <div className="grid gap-3">
                  ...
                  <Input
                    ...
                    required
                    className="h-10 box-border px-4 py-2.5 text-sm border bg-transparent"
                  />
                </div>
                <div className="grid gap-3">
              ...
              <div className="text-center text-sm text-black">
                ...
                <Link to='/register' className="underline underline-offset-4 text-black">
                  Sign up
                </Link>
              </div>
            </div>
      ...
      <div className="text-black text-center text-xs text-balance *:[a]:underline *:[a]:underline-offset-4">
